...
%          left=(betac*Ax*(deltax(1,i)+deltax(1,i))/(deltax(1,i)/permx(1,i)+deltax(1,i)/permx(1,i)))/(mu*Bo(1/2*(pressure(n-1,i)+pressure(n-1,i)))*(1/2*(deltax(1,i)+deltax(1,i))));
         pressure(n,i)=pressure(n-1,i)+((alphac*Bo(pressure(n-1,i))*deltat)/(vb(1,i)*phi*co))*q(1,i)+((alphac*Bo(pressure(n-1,i))*deltat)/(vb(1,i)*phi*co))*(right*pressure(n-1,i+1)-((right)*(pressure(n-1,i))));   

        elseif i==N
%           right=(betac*Ax*(deltax(1,i)+deltax(1,i))/(deltax(1,i)/permx(1,i)+deltax(1,i)/permx(1,i)))/(mu*Bo(1/2*(pressure(n-1,i)+pressure(n-1,i)))*(1/2*(deltax(1,i)+deltax(1,i))));
        ...
        pressure(n,i)=pressure(n-1,i)+(alphac*Bo(pressure(n-1,i))*deltat)/(vb(1,i)*phi*co)*q(1,i)+(alphac*Bo(pressure(n-1,i))*deltat)/(vb(1,i)*phi*co)*(-(left*(pressure(n-1,i)))+(left*pressure(n-1,i-1)));   
