...
%             zarayeb(index,index-Nx)=Tyt;
            ...
            zarayeb(index,index)=-Txr-Tyb-phi*co/(alphac*deltat);
...
%             zarayeb(index,index-Nx)=Tyt;
            zarayeb(index,index+Nx)=Tyb;
            zarayeb(index,index)=-Txl-Tyb-phi*co/(alphac*deltat);
            sabet(index,1)=-phi*co/(alphac*deltat)*pressure(j,i,n-1)-qsc(j,i)/vb;
...
%             zarayeb(index,index-1)=Txl;
            zarayeb(index,index-Nx)=Tyt;
%             zarayeb(index,index+Nx)=Tyb;
            zarayeb(index,index)=-Txr-Tyt-phi*co/(alphac*deltat);
            sabet(index,1)=-phi*co/(alphac*deltat)*pressure(j,i,n-1)-qsc(j,i)/vb;
...
%             zarayeb(index,index+1)=Txr;
            ...
            zarayeb(index,index-Nx)=Tyt;
%             zarayeb(index,index+Nx)=Tyb;
            zarayeb(index,index)=-Txl-Tyt-phi*co/(alphac*deltat);
            sabet(index,1)=-phi*co/(alphac*deltat)*pressure(j,i,n-1)-qsc(j,i)/vb;
...
%             zarayeb(index,index+1)=Txr;
            ...
            zarayeb(index,index-Nx)=Tyt;
            zarayeb(index,index+Nx)=Tyb;
            zarayeb(index,index)=-Txl-Tyt-Tyb-phi*co/(alphac*deltat);
            sabet(index,1)=-phi*co/(alphac*deltat)*pressure(j,i,n-1)-qsc(j,i)/vb;
...
%             zarayeb(index,index-1)=Txl;
            zarayeb(index,index-Nx)=Tyt;
            zarayeb(index,index+Nx)=Tyb;
            zarayeb(index,index)=-Txr-Tyt-Tyb-phi*co/(alphac*deltat);
            sabet(index,1)=-phi*co/(alphac*deltat)*pressure(j,i,n-1)-qsc(j,i)/vb;
...
%             zarayeb(index,index-Nx)=Tyt;
%             zarayeb(index,index+Nx)=Tyb;
            zarayeb(index,index)=-phi*co/(alphac*deltat);
            sabet(index,1)=-phi*co/(alphac*deltat)*pressure(j,i,n-1)-qsc(j,i)/vb;
